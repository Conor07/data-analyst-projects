...
df_UK = df[df['job_country'] == country]

```

View my notebook with detailed steps here: [skills_count](skills_count.ipynb).
...
![Likelihood of Skills Requested in the UK Job Postings](images/Likelihood_of_Skills_Requested_in_United_Kingdom_Job_Postings.png)
...
View my notebook with detailed steps here: [sills_trend](skills_trend.ipynb).
...
![Trending Top Skills for Data Analysts in the UK](images/Trending_Top_Skills_for_Data_Analysts_in_the_United_Kingdom.png)  
...
![Salary Distributions of Data Jobs in the UK](images/Salary_Distributions_of_Data_Jobs_in_the_United_Kingdom.png)  
...
![The Highest Paid & Most In-Demand Skills for Data Analysts in the UK](images/Highest_Paid_and_Most_In_Demand_Skills_for_Data_Analysts_in_the_United_Kingdom.png)
...
![Most Optimal Skills for Data Analysts in the UK](images/Most_Optimal_Skills_for_Data_Analysts_in_the_United_Kingdom.png)  
_A scatter plot visualizing the most optimal skills (high paying & high demand) for data analysts in the UK._
...
![Most Optimal Skills for Data Analysts in the UK with Coloring by Technology](images/Most_Optimal_Skills_for_Data_Analysts_in_the_United_Kingdom_with_Coloring_by_Technology.png)  
